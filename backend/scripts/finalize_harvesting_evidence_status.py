...
def main() -> None:
    ...
    classification_review = _read_json(
        classification_review_path
    )
    ...
    classification_metrics = _read_json(
        classification_metrics_path
    )

    classification_generalization = (
        classification_review.get(
    ...
    decision = {
        ...
        "classification_branch": {
            "selected_model": classification_metrics.get(
                "selected_model"
            ),
            ...
            "test_detected_event_count": (
                classification_review[
                    "test"
                ]["detected_event_count"]
            ),
            "decision": classification_review[
                "decision"
            ],
        },
        "robust_forecasting_branch": {
            ...
            "decision": (
                "Do not construct a readiness score. Persistence "
                "remained best at 48 and 72 hours."
            ),
        },
        ...
        "approved_dashboard_sections": [
            ...
            (
                "Validation alert-policy eligibility with held-out "
                "test miss"
            ),
        ...
        "source_artifacts": {
            "classification_generalization_review": str(
                classification_review_path
            ),
