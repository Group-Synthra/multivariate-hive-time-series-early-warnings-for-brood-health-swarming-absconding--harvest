...
if "MAE" in comparison.columns:
    ...
    colors = [
        "#22c55e" if x == mae_data.min() else "#f59e0b" if x != mae_data.max() else "#ef4444"
        for x in mae_data
    ]
...
if "RMSE" in comparison.columns:
    ...
    colors = [
        "#22c55e" if x == rmse_data.min() else "#f59e0b" if x != rmse_data.max() else "#ef4444"
        for x in rmse_data
    ]
