...
=========================================================
Honey Bee Swarming Prediction
Random Forest Training (UPDATED WITH FIXES)
=========================================================
"""
...
print("=" * 70)
print("RANDOM FOREST MODEL TRAINING (UPDATED)")
print("=" * 70)
...
# =====================================================
# DELETE OLD RANDOM FOREST FILES
# =====================================================

print("\n" + "=" * 70)
print("DELETING OLD RANDOM FOREST FILES")
print("=" * 70)
...
deleted_count = 0
for filename in rf_files_to_delete:
...
if deleted_count == 0:
    print("  No existing Random Forest files found to delete")
else:
...
print("\n" + "=" * 70)
print("RANDOM FOREST PERFORMANCE (BINARY METRICS)")
print("=" * 70)
print(f"  Accuracy : {accuracy:.4f}")
print(f"  Precision: {precision:.4f}")
print(f"  Recall   : {recall:.4f}")
...
METRIC_PATH = os.path.join(OUTPUT_FOLDER, "rf_metrics.json")
with open(METRIC_PATH, "w") as file:
...
CONFUSION_PATH = os.path.join(GRAPH_FOLDER, "rf_confusion_matrix.png")
plt.tight_layout()
...
FEATURE_PATH = os.path.join(GRAPH_FOLDER, "rf_feature_importance.png")
plt.tight_layout()
...
importance.to_csv(os.path.join(OUTPUT_FOLDER, "rf_feature_importance.csv"), index=False)
...
print("\nCSV:")
print(f"  {os.path.join(OUTPUT_FOLDER, 'rf_feature_importance.csv')}")
